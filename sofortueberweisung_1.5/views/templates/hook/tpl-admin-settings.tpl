...
<fieldset style="margin-bottom: 10px;">
    ...
    <div class="margin-form" style="font-size: inherit; padding-top: 3px;">
        {$domain}index.php?fc=module&module=sofortueberweisung&controller=success&cartid=-USER_VARIABLE_0-
    </div>
    <label>{l s='Abort link' mod='sofortueberweisung'}</label>
    <div class="margin-form" style="font-size: inherit; padding-top: 3px;">
        {$domain}index.php?fc=module&module=sofortueberweisung&controller=cancel
    </div>
    <label>{l s='Notification URL (Method: POST)' mod='sofortueberweisung'}</label>
    <div class="margin-form" style="font-size: inherit; padding-top: 3px;">
        {$domain}index.php?fc=module&module=sofortueberweisung&controller=notify
    </div>
